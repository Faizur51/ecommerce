                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.user.store')}}" method="post">
                            ...
                            <div class="col-sm-8">
                                <select name="role_id" id="role" class="form-control">
                                   ...
                                   @foreach($userroles as $userrole)
                                    <option value="{{$userrole->id}}" {{$userrole->id == old('role_id')?'selected':''}}>{{$userrole->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-sm-8">
                                <button type="submit" class="btn btn-primary px-5"><i class="fa fa-save"></i> Add User</button>
                            </div>
                        </div>
                    </form>
                </div>
