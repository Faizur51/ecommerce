                ...
                <form method="POST" action="{{ route('admin.login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-right">
                            <input type="email" id="email" class="form-control input-shadow" name="email" value="{{old('email')}}" placeholder="Enter Username">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-right">
                            <input type="password" id="password" class="form-control input-shadow" name="password" placeholder="Enter Password">
                            <div class="form-control-position">
                                <i class="icon-lock"></i>
                            </div>
                        </div>
